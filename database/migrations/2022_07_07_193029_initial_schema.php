    ...
    public function up()
    {
        ...
        if(!Schema::hasTable('saves')) {
            Schema::create('saves', function (Blueprint $table) {
                $table->bigInteger('uuid', true, false)->nullable(false)->unique();
        ...
        if(!Schema::hasTable('achievements')) {
            Schema::create('achievements', function (Blueprint $table) {
                $table->string('email', 50)->nullable(false)->primary();
                $table->char('one', 4);
                $table->tinyInteger('two', false, true);
                $table->tinyInteger('three', false, true);
                $table->tinyInteger('four', false, true);
                $table->tinyInteger('five', false, true);
                $table->tinyInteger('six', false, true);
                $table->tinyInteger('seven', false, true);
                $table->tinyInteger('eight', false, true);
                $table->tinyInteger('nine', false, true);
                $table->tinyInteger('ten', false, true);
                $table->tinyInteger('eleven', false, true);
                $table->tinyInteger('twelve', false, true);
                $table->tinyInteger('thirteen', false, true);
                $table->tinyInteger('fourteen', false, true);
            });
        }
        ...
        if(!Schema::hasTable('offers')) {
            Schema::create('offers', function (Blueprint $table) {
                $table->bigInteger('id', true, true)->nullable(false)->unique();
