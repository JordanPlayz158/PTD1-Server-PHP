...
<div id="nav">
    ...
    <div id="suckerfish" class="suckerfish">
        <ul class="menu">
            ...
            <li><a href="/games/ptd/account.php">Home</a></li>
            <li><a href="/games/ptd/adoption.php">Pokemon Adoption</a></li>
            <li><a href="/games/ptd/changeAvatar.php">Avatar Store</a></li>
            ...
            <li class="expanded"><a href="/games/ptd/inventory.php">Inventory</a>
                <ul class="menu">
                    ...
                    <li><a href="/games/ptd/changeAvatar.php">Avatars</a></li>
                </ul>
            </li>
            ...
            <li class="expanded"><a href="/games/ptd/createTrade.php">Trading Center</a>
                <ul class="menu">
                    ...
                    <li><a href="/games/ptd/offers.php">Your Offers/Requests</a></li>
