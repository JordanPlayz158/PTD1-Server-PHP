...
<head>
    ...
    <script>
        ...
        window.onload = () => {
            loadProfile(() => {
                $.ajax({
                    url: '/api/saves/?exclude=pokemon,items,id,user_id,num,advanced,advanced_a,classic,classic_a,challenge,npcTrade,shinyHunt,version,created_at,updated_at&save=' + saveNum,
                    type: "GET",
